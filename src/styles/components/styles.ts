export const styles = {
    ...
    search: {
      ...
      input: "w-full bg-[#212224] text-white text-lg rounded-xl px-6 py-4 placeholder:text-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-600 font-geist",
